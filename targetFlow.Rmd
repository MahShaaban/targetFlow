...
The algorithm was implemented in R (>= 3.6) and should be able to run on any operating system. Libraries required for running the workflow are listed and loaded below. Alternatively, a docker image is available with R and the libraries installed on an Ubuntu image: [https://hub.docker.com/r/bcmslab/target_flow](https://hub.docker.com/r/bcmslab/target_flow).
